...
public enum ExemptType
{
    ...
    ATTRIBUTE_MODIFIER(data -> data.getPositionProcessor().getSinceAttributeModifierTicks() < 3),
    ...
    CANCELLED_PLACE(data -> data.getActionProcessor().getSinceCancelledPlaceTicks() < 5),
    BLOCK_PLACE(data -> data.getActionProcessor().getSinceBlockPlaceTicks() < 10),
    ...
    TELEPORT(data -> data.getActionProcessor().getSinceBukkitTeleportTicks() < 5 || data.getActionProcessor().isTeleporting()),
