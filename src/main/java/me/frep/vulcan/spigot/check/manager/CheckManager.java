...
import me.frep.vulcan.spigot.check.impl.combat.killaura.*;
import me.frep.vulcan.spigot.check.impl.movement.noslow.NoSlowE;
import me.frep.vulcan.spigot.check.impl.movement.sprint.SprintB;
import me.frep.vulcan.spigot.check.impl.movement.vclip.VClipB;
import me.frep.vulcan.spigot.check.impl.player.Freecam.FreeCamA;
...
import me.frep.vulcan.spigot.check.impl.combat.killaura.KillAuraY;
    ...
    public static void setup() {
        for (final Class<? extends AbstractCheck> clazz : CheckManager.CHECKS) {
            if (!clazz.isAnnotationPresent(CheckInfo.class)) {
                ...
                //if (Config.ENABLED_CHECKS.get(name) == null) return;
